...
Chan-Cooper companion Lucas replay, the Atkin-Lehner W2 eta-multiplier
certificate replay, and atlas audit/count checks. The package is intentionally curated: it is not a dump of the
